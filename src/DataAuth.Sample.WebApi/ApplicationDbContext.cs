...
namespace DataAuth.Sample.WebApi
{
    public class ApplicationDbContext : DbContext
    {
        ...
        private static void SeedSampleData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Region>().HasData(region1, region2, region3);
            ...
            modelBuilder.Entity<Province>().HasData(province1, province2, province3, province4);
            ...
            var department3 = new Department("Sale back office", "KDO_NVU", department2.Id)
            {
                Id = 3
            };
            var department4 = new Department("Supplier management", "KDO_NVU_VTU", department3.Id)
            {
                Id = 4
            };
            var department5 = new Department("Document management", "KDO_NVU_CTU", department3.Id)
            {
                Id = 5
            };
            ...
            var orderTypeGroup1 = new OrderTypeGroup(
                new Guid("6edc2d8c-ada9-48ea-b347-72a2832607ed"),
                "Offline retail",
                "BL"
            );
            var orderTypeGroup2 = new OrderTypeGroup(
                new Guid("f829ca08-1958-42d8-9aa1-812599b5a9de"),
                "Offline wholesale",
                "DL"
            );
            modelBuilder.Entity<OrderTypeGroup>().HasData(orderTypeGroup1, orderTypeGroup2);
            ...
            modelBuilder.Entity<OrderType>().HasData(orderType1, orderType2);
        }
